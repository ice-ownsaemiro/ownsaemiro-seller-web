    ...
    <SignupContainer>
      ...
      <FormContainer>
        ...
        <div style={{ display: "flex" }}>
          ...
          />
          <SignupCheckButton type="button" onClick={handleEmailVerification}>
            인증하기
          </SignupCheckButton>
        </div>
        {
        ...
        <div style={{ display: "flex" }}>
          ...
          />
          <SignupCheckButton type="button" onClick={handleIDCheck}>
            중복확인
          </SignupCheckButton>
        </div>
        {
      ...
      <SignupEndButton
        ...
        disabled={!isEmailCheck || !isIDCheck || savePW !== confirmPW}
      >
        시작하기
      </SignupEndButton>
    </SignupContainer>
